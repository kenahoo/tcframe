...
implementation.\cite{joachims:99a} Since the macro-averaged scores are
...
For the k-Nearest-Neighbor categorizer (kNN), $results are comparable
with NB, but are not as good as the kNN results in \cite{yang:99}.
...
For all three categorizers, the \param{tfidf\_weighting} was set to
