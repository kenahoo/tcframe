...
scores are much lower than on the ApteMod corpus (see Table
\ref{aptemod-results}), indicating that this may be a more difficult
categorization task simply because the category distribution is a bit
more flat than in ApteMod.
...
SVM       \\
kNN       &   .2343  &  .2692  &  .2128  &  .3602     &  .3501    &  .3551    &  .0215  \\
