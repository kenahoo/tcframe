...
\method{new} method in an aggregation manner \cite[p. 22]{gamma:95}.
...
\item Hashes can store \emph{sparse} information efficiently, meaning
  only nonzero entries in a vector need to be stored.  This can
...
\item Perl's implementation of most data structures is fairly
  ...
  structures to consume much more memory than needed, as is the
  case for the base \class{Feature\-Vector} class.
