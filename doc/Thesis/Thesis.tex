...
formally, given a set of labels L = {L1, ..., Lk} and a set of
previously unseen documents D = {D1, D2, ... }, a categorizer is a
...
\section{AI::Categorizer framework design}
...
\chapter{Use of the AI::Categorizer framework}

\section{Performance evaluation}
\subsection{Descriptions of corpora}
