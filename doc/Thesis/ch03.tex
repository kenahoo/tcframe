...
XXX - make it clear why we're talking about audience here.
...
Note thate the \class{Document} class is not purely an abstract class,
...
threshold, and \method{categorize} translates this data into a
...
\class{Experiment} contains a \method{add\_hypothesis} method for
adding \class{Hypothesis} objects to the set of data to be summarized,
and implements a \method{stats\_table} method for showing the a
