...
Recent standardizations in protocols such as SOAP or XML/RPC (XXX-need to define SOAP & XML/RPC)
...
XXX - Some example usage here (From Rafael: ``The slides you used in
your last seminar would be great'')
