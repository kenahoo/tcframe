...
growth.\cite[p. XXX]{fayad:99} The framework interface must be
...
flexible enough that the framework developer can make appropriate
modifications.
...
delegate actual software development using the framework to the other
...
used, an analysis of use cases is often helpful. \cite{XXX} Use cases
provide details of the required functionality of a project.  They can
also provide a starting point for design of the project's
architecture.  In this section, several common use cases for a Text
Categorization application are discussed.  The design of the framework
should be directed toward satisfying these use cases.
...
discussion purposes.  See Chapter \ref{Implementation} for the actual
...
the framework structure can be highly parameterized.
