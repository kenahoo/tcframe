...
categorizer for comparison.  We give results for the ``Level'' task,
the ``Topic'' task, and 

Comparing the ``Both'' task to the NB


We trained
separate \naive\ Bayes categorizers on the two tasks
...
Both     &    &    &    &    &  \\ \hline
\end{tabular}
\caption{Performance of \naive\ Bayes classifier on various subtasks.}
\label{results-NB}
\end{table}
...
Both     &    &    &    &    &  \\ \hline
\end{tabular}
\caption{Performance of baseline classifier on various subtasks.}
