...
% Ken: here you use a select but in the example you use an insert. This  options are 
% very different because it puts the classification effort at different stages (when storing or when viewing). I think it needs to be explained better and the examples be of the same type as the explanation here
